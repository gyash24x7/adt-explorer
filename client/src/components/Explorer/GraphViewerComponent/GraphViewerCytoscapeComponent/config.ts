...
export const graphStyles: Stylesheet[] = [
	...
	{
		selector: ":selected",
		css: { "border-color": "#900", "line-color": "#900", "target-arrow-color": "#900" }
	},
	{
		selector: "edge",
		style: {
	...
	},
	{
		...
		style: { "border-color": "#900", "line-color": "#900", "target-arrow-color": "#900", width: 3 }
	},
	{
	...
	{ selector: ".opaque", style: { opacity: 0.4 } }
];
...
export const dagreOptions = {
	...
	edgeWeight: () => 1, // higher weight edges are generally made shorter and straighter than lower
	// weight edges
	...
	animateFilter: () => true, // whether to animate specific nodes when animation is on; non-animated
	// nodes immediately go to their final positions
	animationDuration: 500, // duration of animation in ms if enabled
	animationEasing: undefined, // easing of animation if enabled
	boundingBox: undefined, // constrain layout bounds; { x1, y1, x2, y2 } or { x1, y1, w, h }
	transform: (_node: any, pos: any) => pos, // a function that applies a transform to the final node
	// position
...
export const klayOptions = {
	...
	priority: () => null // Edges with a non-nil value are skipped when greedy edge cycle breaking is enabled
};
