...
export type GraphViewerRelationshipDeleteComponentProps = {
	selectedEdge: any;
};

export class GraphViewerRelationshipDeleteComponent extends Component<GraphViewerRelationshipDeleteComponentProps> {
