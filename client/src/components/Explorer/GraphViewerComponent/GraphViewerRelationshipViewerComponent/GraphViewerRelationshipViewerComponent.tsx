...
export type GraphViewerRelationshipViewerComponentProps = {
	selectedNode?: NodeSingular;
};

export class GraphViewerRelationshipViewerComponent extends Component<GraphViewerRelationshipViewerComponentProps> {
	state = {
		isLoading: false,
		outgoingRelationships: null as any,
		incomingRelationships: null as any,
		showModal: false
	};
	...
	getMarkup(relationships: any) {
		return { __html: jsonMarkup(relationships || {}) as string };
	}
		...
		return (
			...
			>
				...
				<div className="btn-group">
					<DefaultButton className="modal-button close-button" onClick={this.close}>
						Close
					</DefaultButton>
				</div>
			</ModalComponent>
