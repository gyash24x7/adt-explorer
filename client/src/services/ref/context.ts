...
export default {
	"@context": {
		...
		AngularAccelerationUnit: { "@id": "dtmi:standard:class:AngularAccelerationUnit;2" },
		...
		LuminousIntensityUnit: { "@id": "dtmi:standard:class:LuminousIntensityUnit;2" },
		MagneticFluxUnit: { "@id": "dtmi:standard:class:MagneticFluxUnit;2" },
		MagneticInductionUnit: { "@id": "dtmi:standard:class:MagneticInductionUnit;2" },
		...
		multiLineString: { "@id": "dtmi:standard:schema:geospatial:multiLineString;2" },
